        ...
        >
            ...
            <CardContent className="p-4 pt-0 flex-grow">
                ...
                <div className="flex flex-wrap gap-x-3 gap-y-1 text-xs text-muted-foreground">
                    <span className="flex items-center">
                        <Users size={12} className="mr-1" /> {property.guests} guests
                    </span>
                    <span className="flex items-center">
                        <BedDouble size={12} className="mr-1" /> {property.bedrooms} bedrooms
                    </span>
                    <span className="flex items-center">
                        <Bath size={12} className="mr-1" /> {property.baths} baths
                    </span>
                </div>
            </CardContent>
            <CardFooter className="p-4 pt-0 border-t mt-auto">
                <div className="flex items-center justify-between w-full">
                    <div>
                        <span className="text-xl font-bold text-foreground">₹{property.pricePerNight.toLocaleString("en-IN")}</span>
